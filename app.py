...
def match_relays_sector(sector_mencionado: str, relay_names_tuple: tuple,
    ...
    if pdf_contexto:
        prompt = (
            ...
            f"{relay_list_str}\n\n"
            "FORMATO DEL SECTOR — el texto del sector suele venir como "
            "'Tipo de trabajo - Sector1 - Sector2 - ...' separado por guiones. Cada "
            "parte separada por un guion es una ENTIDAD INDEPENDIENTE, no una frase "
            "compuesta. Por ejemplo, 'Mantenimiento - Sala Ventas 1' significa DOS "
            "cosas distintas: (a) 'Mantenimiento' — que en el contexto de estos "
            "documentos suele significar 'Mantención Escala/Escalas Mecánica(s)' de "
            "la tabla — Y (b) 'Sala Ventas 1' — que es el piso 1 de sala de ventas. "
            "Debes identificar los relés de TODAS las entidades mencionadas y "
            "combinarlos (unión, no intersección): si el sector dice 'Mantenimiento - "
            "Sala Ventas 1', el resultado debe incluir tanto los relés de Mantención "
            "Escala Mecánica COMO los relés de Trabajos Piso 1 según la tabla, no solo "
            "uno de los dos.\n\n"
            ...
            "conocido, usa el sector (aplicando la regla de entidades independientes "
            "de arriba) como respaldo.\n"
